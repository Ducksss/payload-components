...
<Cards>
  ...
  <Card icon={<GitPullRequest />} title="Contributing" href="/docs/contributing">
    The new-component checklist and how the catalog stays small and verifiable.
  </Card>
</Cards>
...
Prefer to see them first? Browse every component rendered live in the [Component Catalog](/components).
