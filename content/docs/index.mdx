...
<Cards>
  ...
  <Card icon={<Terminal />} title="Install Walkthrough" href="/docs/install-walkthrough">
    Visual checkpoints, copy-paste commands, doctor output, and the raw shadcn boundary.
  </Card>
