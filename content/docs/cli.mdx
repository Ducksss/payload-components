...
description: Every Payload Components CLI command — install blocks and templates, localize a project for multiple languages, diff and update recorded installs, remove a block, and expose the registry to a coding agent.
icon: SquareTerminal
---
