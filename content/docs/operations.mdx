...
| "I need a pricing table or reusable component for a client site."                                 | Component request            | Convert the use case into a small component proposal with target fields, render behavior, manifest needs, and install tests                                |
...
| "I shipped a site with `feature-grid-basic` and can share feedback."                          | Community/show-and-tell     | Ask what worked, what drifted, and whether the user can test alpha installs in a real project                                                              |
