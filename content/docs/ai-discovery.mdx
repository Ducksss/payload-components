...
| `/blog/<slug>.md` | Blog text with author and publication date | `src/lib/blog-source.ts`, `src/app/llms.mdx/blog/[slug]/content.md/route.ts` |
| `/templates/<slug>.md` | Template block recipe, install command, and page plan | `src/lib/template-markdown.ts`, `src/app/llms.mdx/templates/[slug]/content.md/route.ts` |
