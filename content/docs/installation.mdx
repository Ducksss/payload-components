...
For a visual tour of the catalog, install commands, reviewable diff, and doctor report, follow the [visual install walkthrough](/docs/install-walkthrough).
...
If the root config is still taking shape, use the [Payload configuration guide](/docs/payload-configuration)
to map the database, collections, admin user, environment values, and generated output before
installing a block.
