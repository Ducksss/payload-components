...
<BlogFigure
  ...
  alt="A real montage of Payload Components hero, logo, feature, integration, pricing, testimonial, FAQ, and call-to-action previews"
  caption="The montage is a parts inventory, not a prescribed template. Choose the smallest sequence that supports the page's actual argument."
/>
...
const blockComponents = {
  ...
  integrationGrid: IntegrationGridComponent,
  testimonialsGrid: TestimonialsGridComponent,
  pricingCards: PricingCardsComponent,
  faqAccordion: FaqAccordionComponent,
  callToActionCentered: CallToActionCenteredComponent,
}
```
