...
publicationOrder: 1
cover:
  src: /blog/hello/cover.webp
  alt: Hero Basic block config and shared heroFields source beside the registration, renderer mapping, and generation steps that complete an install.
tags:
  - Project notes
  - Open source
  - Payload CMS
...
<BlogFigure
  src="/blog/hello/figure-01-origin-story.svg"
  alt="A joined path from src/blocks/shared/heroFields.ts and Hero Basic source through Pages registration, RenderBlocks mapping, and generated application contracts"
  caption="The shared field source ships with the block; the wiring then makes that owned source part of a working Payload application."
/>
