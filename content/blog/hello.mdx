...
cover:
  ...
  alt: Hero Basic block config beside the registration, renderer mapping, and generation steps that complete an install.
tags:
  - Project notes
  - Open source
  - Payload CMS
...
<BlogFigure
  ...
  alt="A four-step diagram connecting copied block source to registration, renderer mapping, and generated Payload artifacts"
  caption="The small wiring steps after a copy are exactly where a reusable block becomes part of a working Payload application."
/>
