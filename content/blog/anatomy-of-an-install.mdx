...
<BlogFigure
  ...
  alt="The payload-components add pipeline from registry build through file delivery, dependencies, source patches, and generators"
  caption="Each stage has one job, and the state file records the boundary so an interrupted install has an honest recovery path."
/>
