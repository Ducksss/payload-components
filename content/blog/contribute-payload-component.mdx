...
<BlogFigure
  ...
  alt="An end-to-end contribution workflow connecting component source, manifest, registry item, documentation, demo twin, and automated tests"
  caption="Every surface names the same component contract from a different angle; shipping them together prevents a partial catalog entry."
/>
...
Do not create a bare family name. Use `hero-video`, `feature-steps`, or another structural suffix so
the first member does not claim the whole family. Selection happens visually in the catalog, not
through a CLI prompt or a runtime prop matrix.
