          ...
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-16">
            <div className="flex flex-col items-start">
              <SectionHeading
                ...
                intro="Five page blocks install today, eight post components are in development, and every kit ships with its contract: source, manifest, docs, and installer coverage."
              />
