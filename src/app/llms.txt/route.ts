...
export function GET() {
  const body = [
    ...
    `- [Component changelog](${siteUrl}/docs/changelog)`,
    `- [Template concepts](${siteUrl}/templates)`,
    `- [Blog](${siteUrl}${blogRoute})`,
    `- [Blog RSS](${siteUrl}${blogRoute}/rss.xml)`,
    ...
    `Blog posts and template detail pages also support \`.md\` and \`Accept: text/markdown\`: ${siteUrl}/blog/hello.md and ${siteUrl}/templates/saas-launch.md.`,
