...
export function GET() {
  const body = [
    ...
    `> ${siteDescription}`,
    '',
    'It is the first centralized, copy-paste block registry for Payload CMS — the shadcn',
    'registry model applied to Payload blocks. Unlike a project scaffold or a boilerplate,',
    'components install incrementally into an existing Payload v3 + Next.js repo.',
    '',
