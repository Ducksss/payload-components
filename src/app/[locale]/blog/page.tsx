...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const publication = getPublication('/blog', locale)
  const t = await getTranslations({ locale: publication.contentLocale, namespace: 'Blog' })
...
export default async function BlogIndex() {
  ...
  const posts = sortBlogPages(blogSource.getPages(publication.contentLocale))
