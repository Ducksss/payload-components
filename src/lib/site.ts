...
export const siteUrl =
  configuredSiteUrl === "https://payload-components.xyz"
    ? productionSiteUrl
    : configuredSiteUrl;
export const githubRepoUrl = "https://github.com/Ducksss/payload-components";
export const githubIssuesUrl = `${githubRepoUrl}/issues`;
export const githubContentBranch =
  process.env.NEXT_PUBLIC_GITHUB_CONTENT_BRANCH ?? "dev";
...
export const terminalDemoLines = [
  ...
  {
    kind: "info",
    text: 'payload-components: installing "hero-basic" into ./acme-site',
  },
  { kind: "step", text: "resolved hero-basic@0.1.0 · payload-website-starter" },
  {
    kind: "step",
    text: "copied src/blocks/{shared/heroFields.ts, HeroBasic/config.ts, HeroBasic/Component.tsx}",
  },
  ...
  {
    kind: "step",
    text: "recorded install state in .payload-components/state.json",
  },
  {
    kind: "success",
    text: 'payload-components: installed "hero-basic" successfully.',
  },
] as const;
...
export const landingSections = {
  ...
  workflow: {
    heading: "From catalog to commit in three moves.",
    id: "workflow",
  },
} as const;
...
export const taxKicker =
  "One command pays that whole list down — and lands it as a diff you can review.";
...
export const componentsIntro =
  "No screenshots, no skeletons — the specimen below is the real component rendered with sample content. Thirty-nine page blocks install today; eight post components are in development. Nothing ships without its full contract: source, manifest, docs, and installer coverage.";
...
/* Display order on the /components catalog (it reads Object.keys order). Page families are
   ...
   (Hero, Feature, Content, Call to action, Pricing), then the deeper / flashier families
   (Integration, Logo cloud, Team), then the single-variant utility (Embed). FAQ /
...
export const upcomingComponents = [
  {
    category: "cards",
    description:
      "A post card with image, categories, date, title, and excerpt.",
    family: "posts",
    slug: "post-card",
    target: "Archive card",
    title: "Post Card",
  ...
  },
  {
    category: "index",
    description:
      "A compact post list with dates, categories, and descriptions.",
    family: "posts",
    slug: "post-list",
  ...
  },
  {
    category: "author",
    description:
      "An author profile card for article pages and editorial bylines.",
    family: "posts",
    slug: "author-card",
    target: "Byline",
    title: "Author Card",
...
export const surfaceLinks = [
  {
    description:
      "Architecture, install behavior, support matrix, and component contracts.",
    href: "/docs",
    title: "Documentation",
  },
  {
...
export const communityLinks = [
  {
    description:
      "Source, issues, roadmap, and contribution discussion live in the open.",
    href: githubRepoUrl,
    label: "GitHub repository",
  },
  {
    description:
      "Suggest a component, report install drift, or help shape the registry contract.",
    href: githubIssuesUrl,
    label: "Open an issue",
  },
] as const;
...
/* Footer "Components" column: one link per category that actually ships components,
   ...
   instead of dumping all 39 entries into one column. */
const footerComponentCategoryLinks = (
  ...
  },
  {
    links: [
      ...footerComponentCategoryLinks,
      {
        accent: true,
        href: "/components",
        label: `All ${componentEntries.length} components`,
      },
    ],
    title: "Components",
  },
