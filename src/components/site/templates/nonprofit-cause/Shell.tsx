...
/* Rivermouth Trust (nonprofit-cause) template shell — FOUNDATION SKELETON.
 *
 * Owned by the Rivermouth art-direction track: replace with the real chrome
 * (responsive header, keyboard-operable mobile menu, footer, section rhythm).
 * Contract to preserve: render everything under
 * data-template-theme='nonprofit-cause', navigate internally via
 * templatePreviewHref, mark the active page with aria-current, keep the named
 * export NonprofitCauseShell and the TemplateShellProps signature, and keep every
    ...
    >
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-8 text-sm text-muted-foreground sm:px-6">
          <span>Rivermouth Trust — a fictional concept</span>
