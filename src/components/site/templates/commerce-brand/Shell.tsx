...
/* Fieldnote (commerce-brand) template shell — FOUNDATION SKELETON.
 *
 * Owned by the Commerce art-direction track: replace with the real Fieldnote
 ...
 * 'commerce-brand', use real internal navigation via templatePreviewHref, mark
...
export function CommerceBrandShell({ activePath, children, template }: TemplateShellProps) {
  return (
    <div data-template-theme="commerce-brand" className="min-h-screen bg-background text-foreground">
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-8 text-sm text-muted-foreground sm:px-6">
          <span>Fieldnote — a fictional brand concept</span>
