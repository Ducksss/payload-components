...
import { faqCardDemoContent, type FaqDemoContent } from '@/lib/demo-content'

import { DemoLink } from './DemoLink'

/* DEMO TWIN of payload-components/source/blocks/FaqCard/Component.tsx
 * (faq-card@0.1.0). Class strings are copied verbatim from the component
 ...
 *   FaqCardBlockData                          → FaqDemoContent (@/payload-types is consumer-only)
...
export function FaqCardDemo({
  className,
  content = faqCardDemoContent,
}: {
  className?: string
    ...
    <div aria-hidden="true" className={className}>
      <div className="overflow-hidden rounded-frame border border-border/70 bg-card/35 px-6 py-10 sm:px-8 lg:px-12 lg:py-14">
        <div className="mx-auto flex max-w-3xl flex-col gap-10">
          ...
          {items.length > 0 ? (
            <Card className="border-border/70 bg-background/85 p-2 shadow-none">
