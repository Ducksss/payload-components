        ...
        <div className="mx-auto flex max-w-5xl flex-col gap-12">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="flex flex-col gap-4">
              ...
              <div className="text-3xl font-medium tracking-[-0.04em] text-balance sm:text-4xl">
                {title}
              </div>
            </div>
                ...
                <div className="group overflow-hidden" key={index}>
                  ...
                  <div className="px-2 pt-4">
                    <div className="flex items-center justify-between">
                      <div className="text-base font-medium motion-safe:transition-all motion-safe:duration-500 motion-safe:group-hover:tracking-wider">
                        {member.name}
                      </div>
