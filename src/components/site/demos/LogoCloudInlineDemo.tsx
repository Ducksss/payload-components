import { logoCloudInlineDemoContent, type LogoCloudDemoContent } from '@/lib/demo-content'

import { DemoLogoMark, demoLogos } from './DemoLogos'

/* DEMO TWIN of payload-components/source/blocks/LogoCloudInline/Component.tsx
 * (logo-cloud-inline@0.1.0). Class strings are copied verbatim from the
...
export function LogoCloudInlineDemo({
  className,
  content = logoCloudInlineDemoContent,
}: {
  className?: string
