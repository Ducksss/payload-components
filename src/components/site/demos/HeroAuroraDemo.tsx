 ...
 * (hero-aurora@0.1.0). Class strings and the motion choreography are copied
 * verbatim from the component source, in source order. Deliberate
 ...
 *   Media                           → always the DashboardGlow scene (@/components/Media is consumer-side)
...
export function HeroAuroraDemo({
  ...
  return (
    <div aria-hidden="true" className={className}>
      ...
      >
        <AuroraField />
        <div className="relative flex flex-col items-center gap-12 lg:gap-14 mx-auto max-w-6xl">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 text-center">
            ...
            <div className="flex flex-col gap-5">
              <div className="text-4xl font-medium leading-[1.06] tracking-display text-balance text-foreground sm:text-6xl">
