  ...
  return (
    <button
      ...
      className={cn(
        ...
        primary
          ? 'h-11 rounded-full border-primary bg-primary px-4 text-sm text-primary-foreground shadow-[0_16px_36px_-20px_rgba(15,23,42,0.72)] hover:-translate-y-px hover:bg-primary/90 hover:shadow-[0_20px_44px_-20px_rgba(15,23,42,0.78)] data-[copied=true]:border-brand data-[copied=true]:bg-brand data-[copied=true]:text-primary-foreground'
