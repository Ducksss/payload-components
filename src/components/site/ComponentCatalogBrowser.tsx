  ...
  return (
    <section>
      <div className="container grid gap-x-8 py-8 lg:grid-cols-[200px_minmax(0,1fr)] lg:gap-x-12 lg:py-10">
        ...
        {/* These cascade to every .preview-themed surface below; only the demo
            twins read them, so the toolbar and card chrome keep the emerald
            accent and the site's own radius. */}
        <div
          className="min-w-0"
          style={
            {
