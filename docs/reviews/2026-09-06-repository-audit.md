...
| Repository weight    | Removed 233 macOS snapshot images: 103,950,115 bytes (about 104 MB). Linux remains the canonical visual renderer and requires baseline coverage in CI. Git history was not rewritten. Removed the redundant Vite paths plugin and ten unused site exports.                                                                                                                                                                          |
