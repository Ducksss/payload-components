...
FOUNDATION SKELETON. The healthcare-clinic concept currently declares `assets: []` and
...
requires every declared asset to exist under `public/templates/healthcare-clinic/` with
