# Halloran & Sons — asset provenance

FOUNDATION SKELETON. The trade-service concept currently declares `assets: []` and
...
requires every declared asset to exist under `public/templates/trade-service/` with
