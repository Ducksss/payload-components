...
FOUNDATION SKELETON. The education-course concept currently declares `assets: []` and
...
requires every declared asset to exist under `public/templates/education-course/` with
